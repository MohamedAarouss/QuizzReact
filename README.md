...
**Crac'Quiz** est un site de quiz en ligne, il permet de répondre à des quiz déjà présents sur le site créé par les autres utilisateur
...
Pour l'IDE nous avons tous utilisés _WebStorm_ ainsi qu'un répertoire _GitLab_ associé.
...
Et nous avons tous travaillé sur la base de donnée et sur le backend pour mettre en place le serveur.
...
Comme outil de suivi de projet nous avons utilisés _Trello_ qui nous permet de nous organiser selon
